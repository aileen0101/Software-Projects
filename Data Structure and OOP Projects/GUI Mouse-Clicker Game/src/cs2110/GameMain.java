...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        //event, listener, add to button
        startButton.addActionListener(ae ->
                game.startGame()
                );

       // startButton.add(//action listener)
        ...
        game.addPropertyChangeListener(m->
        ...
        speedSlider.addChangeListener(p->
    ...
    private static void saveScore(JFrame frame, int score) {
        ...
        //File saveFile = new File("Score File");
        int show = saveChooser.showSaveDialog(frame);
        File selectedFile = saveChooser.getSelectedFile();
        if (show == JFileChooser.APPROVE_OPTION) {
            try (PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(selectedFile, true)))) {
                out.println(score);
